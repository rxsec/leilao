        ...
        <header className="border-b border-[#d6e0e8] bg-[linear-gradient(180deg,#f3f6f9,#edf2f6)] px-4 py-4 text-[#103f5a] shadow-[0_10px_30px_rgba(16,63,90,0.08)] sm:px-6">
          <div className="flex w-full flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex w-full items-center justify-center gap-6 xl:justify-between xl:gap-12">
              <Link href="/" className="flex w-full items-center justify-center xl:w-auto xl:justify-start">
            ...
            <nav className="grid grid-cols-2 gap-2 xl:hidden sm:grid-cols-4">
              {navigation.map((item) => (
                <Link
                  key={item}
                  href={`#${slugify(item)}`}
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center xl:gap-4">
              ...
              <div className="grid grid-cols-2 gap-3 lg:flex lg:items-center">
                <Link
                  href="/entrar"
                  className="flex h-12 items-center justify-center rounded-2xl border border-[#0f5d86]/18 bg-white px-4 text-sm font-semibold text-[#0f5d86] transition hover:bg-[#eef5fa] sm:px-8"
                >
                  Entrar
                </Link>
                <Link
                  href="/cadastro"
                  className="gold-button inline-flex h-12 items-center justify-center gap-2 rounded-xl px-4 whitespace-nowrap text-sm font-bold transition hover:brightness-95 sm:px-6"
                >
